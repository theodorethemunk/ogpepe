! function(e, t) {
    ...
    return n = [function(e, t, n) {
        ...
        var n = (n = n(1)) && n.__esModule ? n : {
                default: n
            },
            i = n.default;
        t.default = i, t.default = n.default, e.exports = t.default
    }, function(e, t, n) {
        "use strict";
        ...
        s = [{
            ...
            value: function() {
                var t = 0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : {},
                    ...
                    n = t.settings,
                    i = t.callbacks,
                    s = ((e = e instanceof Node ? [e] : e) instanceof NodeList && (e = [].slice.call(e)), !0),
                    t = !1,
                    o = void 0;
                try {
                    for (var a, l = e[Symbol.iterator](); !(s = (a = l.next()).done); s = !0) {
                        var r = a.value;
                        "universalTilt" in r || (r.universalTilt = new c(r, n, i))
                    }
                } catch (e) {
                    t = !0, o = e
                } finally {
            ...
            key: "getValues",
            value: function() {
                this.isMobile() ? (i = this.event.accelerationIncludingGravity.x / 4, e = this.event.accelerationIncludingGravity.y / 4, 90 === window.orientation ? (t = (1 - e) / 2, e = (1 + i) / 2, i = t) : -90 === window.orientation ? (t = (1 + e) / 2, e = (1 - i) / 2, i = t) : 0 === window.orientation ? (e = t = (1 + e) / 2, i = (1 + i) / 2) : 180 === window.orientation && (e = t = (1 - e) / 2, i = (1 - i) / 2)) : "element" === this.settings.base ? (i = (this.event.clientX - this.left) / this.width, e = (this.event.clientY - this.top) / this.height) : "window" === this.settings.base && (i = this.event.clientX / window.innerWidth, e = this.event.clientY / window.innerHeight), i = Math.min(Math.max(i, 0), 1), e = Math.min(Math.max(e, 0), 1);
                var e, t = (this.settings.max / 2 - i * this.settings.max).toFixed(2),
                    n = (e * this.settings.max - this.settings.max / 2).toFixed(2),
                    i = Math.atan2(i - .5, .5 - e) * (180 / Math.PI);
                return {
                    tiltX: this.reverse * t,
                    tiltY: this.reverse * n,
                    angle: i
                }
            }
        }, {
            ...
            value: function(e) {
                ...
                for (t in n)
                    if (t in e) i[t] = e[t];
                    else if (this.element.getAttribute("data-".concat(t))) {
                    var s = this.element.getAttribute("data-".concat(t));
                    try {
                        i[t] = JSON.parse(s)
                    } catch (e) {
                        i[t] = s
        ...
        function c(e) {
            ...
            o(this, "onMouseEnter", function() {
                t.updateElementPosition(), t.transitions(), "function" == typeof t.callbacks.onMouseEnter && t.callbacks.onMouseEnter(t.element)
            }), o(this, "onMouseMove", function(e) {
                null !== t.updateCall && cancelAnimationFrame(t.updateCall), t.event = e, t.updateElementPosition(), t.updateCall = requestAnimationFrame(function() {
                    return t.update()
                }), "function" == typeof t.callbacks.onMouseMove && t.callbacks.onMouseMove(t.element)
            }), o(this, "onMouseLeave", function() {
                t.transitions(), requestAnimationFrame(function() {
                    return t.reset()
                }), "function" == typeof t.callbacks.onMouseLeave && t.callbacks.onMouseLeave(t.element)
            }), o(this, "onDeviceMove", function(e) {
                t.event = e, t.update(), t.updateElementPosition(), t.transitions(), "function" == typeof t.callbacks.onDeviceMove && t.callbacks.onDeviceMove(t.element)
        ...
        t.default = l, "undefined" != typeof document && (window.UniversalTilt = l, (a = document.querySelectorAll("[data-tilt]")).length && l.init({
            elements: a
    ...
    }], i = {}, s.m = n, s.c = i, s.d = function(e, t, n) {
